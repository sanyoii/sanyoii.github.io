# Day 1 — Master Career Timeline (Sanitized Public Edition)

> Status: Complete v1  
> Purpose: public source of truth for employers, dates, titles, product scope, work mode, and career transitions.

## Career chronology

| Period | Employer | Employment title | Product／scope | Public contribution summary | Work mode |
|---|---|---|---|---|---|
| Apr 2006–Apr 2010 | Tatung Co. | Firmware Engineer | LCD TV embedded firmware; smart-meter electronic control systems | Developed firmware in C and control-system software in Java; collaborated with hardware, manufacturing, and product teams on stable releases for Taiwan, European, and US markets. | Taipei, on-site |
...
## Formal titles and actual assignments
...
- EN: `Completed Taiwan's national-defense service program, the predecessor of today's R&D Substitute Service.`
- ZH: `完成台灣國防役制度，該制度為現行研發替代役的前身。`

### Trend Micro

- EN: `After a long tenure spanning QA, customer engineering, and enterprise product support, I pursued exposure to a different product domain and engineering model.`
- ZH: `在 QA、Customer Engineering 與企業產品支援累積長期經驗後，我希望接觸不同的產品領域與工程模式。`
...
- EN: `The role scope changed shortly after I joined. After evaluating the revised direction, I decided it was not aligned with my long-term QA and product-quality path.`
- ZH: `到職後職務方向出現調整；評估新的工作範圍後，我認為它與長期 QA 與產品品質方向不一致，因此決定離開。`

### Career break

- EN: `Career break for family caregiving; the situation is stable, and I am available for full-time remote work.`
- ZH: `因家庭照護暫停全職工作；目前安排已穩定，可以投入 Full-time Remote 工作。`
...
- Employers、dates and employment titles are treated as fixed chronology.
- Public descriptions use qualitative impact when source data cannot be independently recomputed.
- Former-employer information is sanitized; no internal documents or proprietary implementation details are published.
